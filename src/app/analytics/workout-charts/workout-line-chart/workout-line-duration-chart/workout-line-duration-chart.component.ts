...
@Component({
  selector: 'app-workout-line-duration-chart',
  templateUrl: './workout-line-duration-chart.component.html',
  styleUrls: ['./workout-line-duration-chart.component.css']
})
export class WorkoutLineDurationChartComponent implements OnInit {
